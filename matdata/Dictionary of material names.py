...
#updated with conductivity and lin expansion so far 12/11/2018
material_names = {"Inconel_718":"Inconel 718 (UNS N107718)", "AL_ALY_1100":"1100 Aluminum (UNS A91100)", "AL_ALY_3003":" 3003F Aluminum (UNS A93003)",
                  ...
                  "SS_310":"310 Stainless (UNS S31000)", "SS_316":"316 Stainless (UNS S31600)", "Teflon":"Teflon", "Ti_6AL_4V":"Ti 6Al 4V (UNS R56400)","Titanium_15_3_3_3":"Titanium 15-3-3-3 Composition: Bal Ti, 14.88% V, 3.13 Cr, 2.88 Sn, 3.00 Al",
                  ...
                  "Apiexon_N":"Apiexon N","Copper_OFHC":"OFHC Copper (UNS C10100/C10200)", "Fiberglass Epoxy":"G-10 CR (Fiberglass Epoxy)", "Indium":"Indium","Polystyrene_99d":"Polystyrene density: 99.96 kg/m3 (=6.24 lb/ft3)",
                  "Polystyrene_9d":"Polystyrene density: 9.93 kg/m3 (=0.062 lb/ft3)","Polystyrene_60d":"Polystyrene density: 60.07 kg/m3 (=3.75 lb/ft3)","Polyurethane_389d":"Polyurethane density: 389.25 kg/m3 (=24.3 lb/ft3 air Filled)",
                  "PVC_48d":"Polyvinyl Chloride (PVC) density: 48.05 kg/m3 (=3.00 lb/ft3)","":""}

while (True):
    check = input()
    output = material_names[check]
    print(output)
